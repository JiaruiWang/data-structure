...
void dfs(int x, int y, char **map3, short **map2, bool **visited, int &total)
{
  ...
  {
    elevationChange = abs(map2[x][y] - map2[x][y + 1]);
  ...
  {
    elevationChange = abs(map2[x][y] - map2[x - 1][y + 1]);
    total += elevationChange * elevationChange + 10;
  ...
  {
    elevationChange = abs(map2[x][y] - map2[x - 1][y]);
    total += elevationChange * elevationChange + 10;
...
void checkRoute(short **map2, const CityPos *cityPos, int cityCount, Edge *paths,
